    ...
    >
      ...
      <div className="relative" ref={containerRef}>
        ...
        >
          ...
          {/* Decorative Cloud 1 - Top right area (between border and 東) */}
          <g transform="translate(260, 55) scale(0.35)" opacity="0.5">
          ...
          {/* Decorative Cloud 2 - Middle left (between 遇 and 見) */}
          <g transform="translate(45, 200) scale(0.4)" opacity="0.4">
